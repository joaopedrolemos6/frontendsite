      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-dark max-w-3xl mx-auto text-lg">
            Estamos prontos para transformar seu negócio com soluções tecnológicas inteligentes
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:contato@licitum.com.br" 
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <address className="not-italic text-dark">
                    Av. Gov. Flavio Ribeiro Coutinho, 500,<br />
                    Jardim Oceania<br />
                    João Pessoa - PB
                  </address>
                </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-dark">Horário</h4>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <h4 className="font-medium text-dark mb-3">Redes Sociais</h4>
              <div className="flex space-x-4">
                ...
                <a 
                  href="https://www.instagram.com/licitumtech?igsh=eDNjeXB1M3V6azlt&utm_source=qr" 
                  className="bg-primary/10 p-3 rounded-lg text-primary hover:bg-primary hover:text-white transition-colors"
